...
def predict(
    ...
    for batch in tqdm(dataset):
        ...
        with torch.no_grad():
            forecast_output, _, (_, dec_cross_attns),_ = forecaster.forward(
                data_input=X,
                data_trg=trg,
                kwargs=kwargs)
...
def predict_test_from_ckpt(
    ...
    2) Loads the training dataset as specified by the config
...
if __name__ == "__main__":
    ...
    checkpoint_path = r"C:\Users\ScipioneFrancesco\Documents\Projects\prochain_transformer\experiments\training\dx_250406_epoch_sweeps\sweeps\sweep_max_epochs\sweep_max_epochs_1000\k_1\checkpoints\epoch=999-train_loss=0.02.ckpt"
    config_path = r"C:\Users\ScipioneFrancesco\Documents\Projects\prochain_transformer\experiments\training\dx_250406_epoch_sweeps\config.yaml"

...
EXP_TAG="baseline_LSTM_ishigami_cat"
...
CLI="$PROJ_HOME/proT/euler_optuna/cli.py"
...
srun python "$CLI" paramsopt --exp_id "$EXPERIMENT_ID" --cluster --study_name "$STUDY_NAME" --mode resume --scratch_path "$SCRATCH_EXP" --study_path "$HOME_EXP/optuna"
